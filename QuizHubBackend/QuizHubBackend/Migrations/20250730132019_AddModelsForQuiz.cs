...
{
    public partial class AddModelsForQuiz : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizId = table.Column<int>(type: "int", nullable: false),
                    RightAnwers = table.Column<int>(type: "int", nullable: false),
                    Points = table.Column<int>(type: "int", nullable: false),
                    TimeDuration = table.Column<int>(type: "int", nullable: false),
                    DateOfCompletition = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
